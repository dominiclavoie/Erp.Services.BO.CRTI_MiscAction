...
{
    class JobBatchProductionAssemblage : BaseJobBatchProduction, IJobBatchProduction
    {
        private static Func<ErpContext, string, string[], IEnumerable<LaborDtl>> selectLaborByJobBatch;
        public JobBatchProductionAssemblage(Erp.ErpContext db, Epicor.Hosting.Session session) : base(db, session){}
